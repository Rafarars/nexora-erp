...
| Configuración de la empresa y monedas | Qué valores lleva y dónde vive; multimoneda con tasas (decidido: en esta fase) | Artículos (antes de listas de precio) | 🔍 [temas/configuracion-empresa.md](temas/configuracion-empresa.md) |
