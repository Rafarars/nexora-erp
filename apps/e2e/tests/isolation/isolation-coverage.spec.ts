...
const IDENTIFIER_FIELD = /\b(userId|roleId|roleIds|tenantId|categoryId|taxId|unitId|warehouseId|itemId|supplierId|orderId|orderLineId|customerId|dispatchId|invoiceId)\s*:/;
