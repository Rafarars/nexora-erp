...
@Module({
  imports: [ConfigModule, SharedModule, HealthModule, AccessModule, CatalogModule, InventoryModule, PurchasingModule, SalesModule, ReceivablesModule, ReportingModule],
})
