...
const cases: Array<[DomainError, typeof DomainError]> = [
  ...
  [new errors.InvalidAdjustmentTypeError('x'), InvalidArgumentError],
  [new errors.MissingRevaluationCostError(1), InvalidArgumentError],
  [new errors.NothingToRevalueError(ID), ConflictError],
