import { InvalidItemUnitsError } from '../errors/item.errors.js';
...
export class ItemUnit {
  ...
  static of(unitId: string, conversionFactor: number, isBase: boolean): ItemUnit {
    return new ItemUnit(UnitRef.of(unitId), ConversionFactor.of(conversionFactor), isBase);
  }
