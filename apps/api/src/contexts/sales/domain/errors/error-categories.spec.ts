...
const cases: Array<[DomainError, typeof DomainError]> = [
  ...
  [new errors.CustomerWithOpenOrdersError(ID), ConflictError],
  [new errors.DispatchBeforeOrderError('2026-01-01'), ConflictError],
  [new errors.InvoiceBeforeOriginError('2026-01-01'), ConflictError],
  ...
  [new errors.OrderNotDirectlyInvoiceableError(ID), ConflictError],
