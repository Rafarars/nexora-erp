...
describe('Quantity', () => {
  ...
  // El factor del articulo se guarda con ocho decimales y la orden tiene que usarlos: con
  // cuatro, comprar doce piezas de una docena entraba como 0,9996.
  ...
  // La parte proporcional de una entrada no toca el factor: ya viene en unidad base.
